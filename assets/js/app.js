...
<a class="navbar-brand" href="index.html">Lesyon </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   <li class="nav-item nav-item-hover"><a class="nav-link" href="index.html">Main Page</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="https://dtd.codes/" target="_blank">DTD Company</a></li>
   <li class="nav-item">
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
      ...
      <p class="tag" >💖 Let me give you brief information about myself.
      ...
      🔮 I will now share my open source projects for the benefit of all users.</p>
    </div>
    ...
    <a class="social-button instagram" href="https://instagram.com/lesyonx" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/lesyonx" target="_blank">
